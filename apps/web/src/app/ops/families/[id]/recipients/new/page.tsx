...
export const metadata = { title: 'Add recipient' };
    ...
    <div className="max-w-[640px]">
      ...
      <header className="mb-8">
        ...
        <p className="text-stone text-[0.9375rem] leading-[1.55] mt-2">
          For an elderly couple, two parents in the same household, or any
          case where the family pays for visits to more than one person.
          After creation we take you to the recipient profile so you can
          fill in address, consents, and the rest.
        </p>
      </header>

      <AddRecipientForm familyId={family.id} />
    </div>
  );
}
